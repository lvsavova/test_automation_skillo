...
public class ExampleTests {
    ...
    public void testRadioButtons() {
        ...
        WebElement yesRadioButtonLabel = smallWait.until(
                ExpectedConditions.elementToBeClickable(By.cssSelector("[for='yesRadio']")));
        ...
        WebElement impressiveRadioButtonLabel = smallWait.until(
                ExpectedConditions.elementToBeClickable(By.cssSelector("[for='impressiveRadio']")));
        ...
        WebElement noRadioButtonLabel = smallWait.until(ExpectedConditions.elementToBeClickable(By.id("[for='noRadio']")));
    ...
    public void printTableSimple() {
        ...
        WebElement tableHeader = driver.findElement(By.className("rt-thead"));
        List<WebElement> tableHeaderCells = tableHeader.findElements(By.cssSelector("[role='columnheader']"));
        for (WebElement tableHeaderCell : tableHeaderCells) {
            System.out.print(tableHeaderCell.getText() + " ");
        }
        System.out.println();

        List<WebElement> tableRows = driver.findElements(By.cssSelector("[role='rowgroup']"));
        for (WebElement row : tableRows) {
            List<WebElement> rowCells = row.findElements(By.cssSelector("[role='gridcell']"));
